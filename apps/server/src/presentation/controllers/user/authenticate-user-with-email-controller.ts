import { type AuthenticateUserWithEmailUseCase } from "@/domain/use-cases/user/authenticate-user-with-email-use-case";
...
import { type Controller } from "@/presentation/protocols/controller/controller";
